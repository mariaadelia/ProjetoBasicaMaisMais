package ClasseRecebedor;

import java.util.Scanner;

import Pessoas.PessoasClasse;
...
public class Recebedor extends PessoasClasse {
	...
	//Atributos
		...
		public Recebedor cadastro() {
			...
			System.out.print("\nHorário de Retirada da Cesta (Das 12h às 18h): ");
		...
		public String toString() {
			return "[ Nome: " + super.getNome() + "\t\tIdade: " + super.getIdade() + "\t\tEndereço: " + super.getEndereco() + "\nCPF/RG: " + super.getCpfRg() + "\t\tTelefone: " + super.getTelefone() +
					"\tRegião: " + super.getRegiao() + "\nQuantidade de Familiares: " + this.getQuantidadeDeFamiliares() +"\tTipo de Cesta: " + this.tipoDeCesta + "\tHorário de Retirada da Cesta: " + this.getHorarioDeRetirada()+ "h]\n";
 		}
}
